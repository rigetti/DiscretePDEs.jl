...
geo_code = GeoCode(gdspy_open(joinpath(@__DIR__, "microstrip_resonator.gds"), "main"),
...
geo_write!(file_name, geo_code, characteristic_length_factor=1, random_factor=1e-8,
