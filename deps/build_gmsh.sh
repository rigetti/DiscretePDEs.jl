#!/bin/bash
: '
This script installs gmsh on a Linux machine with Ubuntu:18.10. The configuration is
largely taken from these instructions:
https://gitlab.onelab.info/gmsh/gmsh/wikis/Gmsh-compilation#opencascade.
'
set -e # stop at the first error

echo "Building gmsh from source."
